    ...
    namespace lucene {
      namespace analysis {
        namespace minhash {
          ...
          class MinHashFilterFactory : public ::org::apache::lucene::analysis::util::TokenFilterFactory {
           public:
            enum {
            ...
            explicit MinHashFilterFactory(jobject obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {
              if (obj != NULL && mids$ == NULL)
                env->getClass(initializeClass);
            }
            MinHashFilterFactory(const MinHashFilterFactory& obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {}
