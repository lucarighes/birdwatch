    ...
    namespace lucene {
      namespace analysis {
        namespace pattern {
          ...
          class PatternTypingFilterFactory : public ::org::apache::lucene::analysis::util::TokenFilterFactory {
           public:
            enum {
            ...
            explicit PatternTypingFilterFactory(jobject obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {
              if (obj != NULL && mids$ == NULL)
                env->getClass(initializeClass);
            }
            PatternTypingFilterFactory(const PatternTypingFilterFactory& obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {}
