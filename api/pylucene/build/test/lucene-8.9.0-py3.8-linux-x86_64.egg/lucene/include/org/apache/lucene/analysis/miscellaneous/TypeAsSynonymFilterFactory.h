    ...
    namespace lucene {
      namespace analysis {
        namespace miscellaneous {
          ...
          class TypeAsSynonymFilterFactory : public ::org::apache::lucene::analysis::util::TokenFilterFactory {
           public:
            enum {
            ...
            explicit TypeAsSynonymFilterFactory(jobject obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {
              if (obj != NULL && mids$ == NULL)
                env->getClass(initializeClass);
            }
            TypeAsSynonymFilterFactory(const TypeAsSynonymFilterFactory& obj) : ::org::apache::lucene::analysis::util::TokenFilterFactory(obj) {}
