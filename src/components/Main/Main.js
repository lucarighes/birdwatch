    ...
    <React.Fragment>
      <div className="wrapper">
        ...
        <div className="two">
          ...
          <h4>The BirdWatch Observatory analyzes the fact-checking crowdsourcing
...
describing our work is available on <a href="https://www.eurecom.fr/~papotti/">request</a>.</p>
          <br></br>
          <hr></hr>
          <p><small>Terms of Use: This Website and its contents herein, including all data,
